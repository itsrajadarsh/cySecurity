      ...
      >
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-black ss:leading-[100.8px] leading-[75px]">
            Unleashing Unrivalled <br className="sm:block hidden" />{" "}
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-3`}>
          CySecurity: Elevating Cybersecurity Excellence for Unyielding Defense.
          Trust in our advanced solutions to fortify your digital frontier and
          safeguard your assets resiliently.
        </p>
      </div>
